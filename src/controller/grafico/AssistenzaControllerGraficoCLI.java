...
public class AssistenzaControllerGraficoCLI {

    private final GestoreAssistenza gestoreAssistenza;
    private final GestoreUtenti gestoreUtenti;

    public AssistenzaControllerGraficoCLI(GestoreAssistenza gestoreAssistenza, GestoreUtenti gestoreUtenti) {
    ...
    public boolean datiContattoGiaNoti() {
        return gestoreUtenti.getUtenteLoggato() != null;
    }
}
